...
#     go_test_cdek(browser, width=1536, height=864)x
#
#
...
# def test_cdek_item(browser):
#     # cdek = CdekPage(browser, width=1024, height=1000)
#     cdek = CdekPage(browser, width=1920, height=1080)
#     cdek.go_to_site('https://cdek.shopping')
#     cdek.item()
#
#
# def test_cdek_slider(browser):
#     # cdek = CdekPage(browser, width=1024, height=1000)
#     cdek = CdekPage(browser, width=1920, height=1080)
#     cdek.go_to_site('https://cdek.shopping')
#     cdek.slider()

def test_cdek_laptop(browser):
    # cdek = CdekPage(browser, width=1024, height=1000)
    cdek = CdekPage(browser, width=1920, height=1080)
    cdek.go_to_site('https://cdek.shopping')
    cdek.catalog_filter()

def test_cdek_page_laptop(browser):
    # cdek = CdekPage(browser, width=1024, height=1000)
    cdek = CdekPage(browser, width=1920, height=1080)
    cdek.go_to_site('https://cdek.shopping/p/215383/noutbuk-apple-macbook-pro-14-m2-pro-2023-16-gb512-gb-angliiskaya-klaviatura-silver')
    cdek.catalog_filter()
